...
class App {
  ...
  createMedias(items, bend, textColor, borderRadius, font) {
    const defaultItems = [
      { image: 'https://picsum.photos/800/600?random=1', text: 'Image 1' },
      { image: 'https://picsum.photos/800/600?random=2', text: 'Image 2' },
      { image: 'https://picsum.photos/800/600?random=3', text: 'Image 3' },
      { image: 'https://picsum.photos/800/600?random=4', text: 'Image 4' },
      { image: 'https://picsum.photos/800/600?random=5', text: 'Image 5' },
      { image: 'https://picsum.photos/800/600?random=6', text: 'Image 6' }
    ];
